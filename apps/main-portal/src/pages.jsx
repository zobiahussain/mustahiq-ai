...
export function Dashboard({ data, navigate, open }) {
  ...
  return <><PageHeading eyebrow="TOGETHER, WE MAKE A DIFFERENCE" title="Welcome back." description="A little clarity. A lot more care. Here’s where your team can help today."><span className="date-label">{dateLabel(new Date())}</span><button className="button primary" onClick={() => open({ type: 'profile-form' })}><Plus size={17}/> Register beneficiary</button></PageHeading>
